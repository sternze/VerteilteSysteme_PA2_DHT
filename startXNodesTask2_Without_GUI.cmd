...
timeout 1
start cmd /C "ant -buildfile build_task2.xml runNode -DMyIp=%MyIp%"
...
timeout 1
start cmd /C "ant -buildfile build_task2.xml runNode -DServiceName=PA2_MyKV -DNodeIP:Port=%ConnectingNodeIp%:8000 -DMyIp=%MyIp%"
